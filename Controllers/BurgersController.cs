...
namespace EmilioAlbornoz_WebCF.Controllers
{
    public class BurgersController : Controller
    {
        private readonly EmilioAlbornoz_WebCFContext _context;

        public BurgersController(EmilioAlbornoz_WebCFContext context)
        {
            _context = context;
        }
